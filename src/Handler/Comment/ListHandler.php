 ...
 * 
 * @OA\Post(
 *     path="/mia_forum_comment/list",
 *     summary="MiaForumComment List",
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaForumComment")
 *                  )
 *              }
 *          )
 *     ),
...
class ListHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = \Mia\Forum\Repository\MiaForumCommentRepository::fetchByConfigure($configure);
