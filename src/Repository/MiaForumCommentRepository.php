...
namespace Mia\Forum\Repository;

use \Illuminate\Database\Capsule\Manager as DB;

/**
 * Description of MiaForumCommentRepository
 *
 * @author matiascamiletti
 */
class MiaForumCommentRepository 
{
    /**
     * 
    ...
    {
        $query = \Mia\Forum\Model\MiaForumComment::select('mia_forum_comment.*');
